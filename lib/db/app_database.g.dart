...
class $CardEmbeddingsTable extends CardEmbeddings
    with TableInfo<$CardEmbeddingsTable, CardEmbedding> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CardEmbeddingsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _factIdMeta = const VerificationMeta('factId');
  @override
  late final GeneratedColumn<String> factId = GeneratedColumn<String>(
      'fact_id', aliasedName, false,
  ...
  late final GeneratedColumn<int> updatedAt = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [factId, dim, vector, model, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'card_embeddings';
  @override
  VerificationContext validateIntegrity(Insertable<CardEmbedding> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('fact_id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {factId};
  @override
  CardEmbedding map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CardEmbeddingsTable createAlias(String alias) {
    return $CardEmbeddingsTable(attachedDatabase, alias);
  }
}

class CardEmbedding extends DataClass implements Insertable<CardEmbedding> {
  final String factId;
  final int dim;
  final String vector;
  final String model;
  ...
  CardEmbeddingsCompanion toCompanion(bool nullToAbsent) {
    return CardEmbeddingsCompanion(
      factId: Value(factId),
      dim: Value(dim),
      vector: Value(vector),
      model: Value(model),
  ...
  factory CardEmbedding.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return CardEmbedding(
      factId: serializer.fromJson<String>(json['factId']),
  ...
  CardEmbedding copyWithCompanion(CardEmbeddingsCompanion data) {
    return CardEmbedding(
      factId: data.factId.present ? data.factId.value : this.factId,
  ...
  @override
  String toString() {
    return (StringBuffer('CardEmbedding(')
          ..write('factId: $factId, ')
          ..write('dim: $dim, ')
          ..write('vector: $vector, ')
          ..write('model: $model, ')
  ...
  @override
  int get hashCode => Object.hash(factId, dim, vector, model, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CardEmbedding &&
          other.factId == this.factId &&
          other.dim == this.dim &&
...
class CardEmbeddingsCompanion extends UpdateCompanion<CardEmbedding> {
  final Value<String> factId;
  final Value<int> dim;
  ...
  CardEmbeddingsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        model = Value(model),
        updatedAt = Value(updatedAt);
  static Insertable<CardEmbedding> custom({
    Expression<String>? factId,
    Expression<int>? dim,
  ...
  CardEmbeddingsCompanion copyWith(
      {Value<String>? factId,
      Value<int>? dim,
      Value<String>? vector,
      Value<String>? model,
  ...
  @override
  String toString() {
    return (StringBuffer('CardEmbeddingsCompanion(')
          ..write('factId: $factId, ')
          ..write('dim: $dim, ')
          ..write('vector: $vector, ')
          ..write('model: $model, ')
...
class Goal extends DataClass implements Insertable<Goal> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, title, goalType, targetValue,
      currentValue, unit, deadline, status, createdAt, completedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Goal &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CardEmbeddingsTable cardEmbeddings = $CardEmbeddingsTable(this);
  late final $GoalsTable goals = $GoalsTable(this);
  late final CardDao cardDao = CardDao(this as AppDatabase);
  late final CardEmbeddingDao cardEmbeddingDao =
      CardEmbeddingDao(this as AppDatabase);
...
typedef $$UserNotificationsTableProcessedTableManager = ProcessedTableManager<
    ...
    UserNotification,
    PrefetchHooks Function()>;
typedef $$CardEmbeddingsTableCreateCompanionBuilder = CardEmbeddingsCompanion
    Function({
  required String factId,
  required int dim,
  required String vector,
...
typedef $$CardEmbeddingsTableUpdateCompanionBuilder = CardEmbeddingsCompanion
    Function({
  Value<String> factId,
  Value<int> dim,
  Value<String> vector,
...
class $$CardEmbeddingsTableFilterComposer
    extends Composer<_$AppDatabase, $CardEmbeddingsTable> {
  $$CardEmbeddingsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CardEmbeddingsTableOrderingComposer
    extends Composer<_$AppDatabase, $CardEmbeddingsTable> {
  $$CardEmbeddingsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CardEmbeddingsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CardEmbeddingsTable> {
  $$CardEmbeddingsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CardEmbeddingsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $CardEmbeddingsTable,
    CardEmbedding,
    $$CardEmbeddingsTableFilterComposer,
    $$CardEmbeddingsTableOrderingComposer,
    $$CardEmbeddingsTableAnnotationComposer,
    $$CardEmbeddingsTableCreateCompanionBuilder,
    $$CardEmbeddingsTableUpdateCompanionBuilder,
    (
      CardEmbedding,
      BaseReferences<_$AppDatabase, $CardEmbeddingsTable, CardEmbedding>
    ),
    CardEmbedding,
    PrefetchHooks Function()> {
  $$CardEmbeddingsTableTableManager(
      _$AppDatabase db, $CardEmbeddingsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CardEmbeddingsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CardEmbeddingsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CardEmbeddingsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> factId = const Value.absent(),
...
typedef $$CardEmbeddingsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CardEmbeddingsTable,
    CardEmbedding,
    $$CardEmbeddingsTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$CardEmbeddingsTableTableManager get cardEmbeddings =>
      $$CardEmbeddingsTableTableManager(_db, _db.cardEmbeddings);
