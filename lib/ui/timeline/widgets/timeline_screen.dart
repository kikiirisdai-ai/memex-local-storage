...
/// Controls whether the persona (companion) chat entry points are shown.
/// reversible: flip to true to restore persona chat (header avatar button
/// and the tappable character avatar in card detail comments).
const bool kShowPersonaChat = false;

/// Controls whether the Action Center notification bell (timeline header)
/// is shown. reversible: flip to true to restore the bell button. Does not
/// remove ActionCenterSheet or the pending-attachment-count logic.
const bool kShowActionCenter = false;

/// Controls whether the user can navigate to the schedule aggregator
/// screen (tapping a schedule-briefing card, or a schedule chat artifact).
/// reversible: flip to true to restore schedule entry points. Does not
/// remove ScheduleAggregatorScreen or the schedule aggregation skill.
const bool kShowScheduleEntry = false;
          ...
          children: [
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        // Notification button
                        if (kShowActionCenter && AppDatabase.isInitialized)
                          Builder(
                            builder: (context) {
                        ...
                        // Card search button
                        GestureDetector(
                          key: const ValueKey('timeline_search_button'),
                          onTap: () => context.push(AppRoutes.cardSearch),
            ...
            if (vm.activeFilter != 'all')
              Padding(
                ...
                child: GestureDetector(
                  key: const ValueKey('timeline_clear_filter_chip'),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          UserStorage.l10n.timelineFilterAll,
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.w500,
                            fontSize: 12,
            ...
            // Nudges the user to export a backup when it's overdue.
            // Self-hides when no nudge is needed.
            const ExportReminderBanner(),
