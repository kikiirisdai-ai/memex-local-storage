...
void validateTemplateData(String templateId, Map<String, dynamic> data) {
  ...
  switch (templateId) {
    ...
    case 'video':
      ...
      break;
    case 'media_card':
      _optStr(data, 'media_type');
      _optStr(data, 'media_status');
      _optStr(data, 'title');
      _optStr(data, 'comment');
      _optNum(data, 'rating');
      break;
...
'''
  ...
  {
    'template_id': 'media_card',
    'use_case': 'User recording a book/movie/tv/music/podcast they are '
        'consuming — title + medium + status + rating + note.',
    'data_structure': '''
- `media_type` (String, optional): Medium, one of "book", "movie", "tv", "music", "podcast", "other".
- `media_status` (String, optional): Status, one of "want", "doing", "done".
- `title` (String, optional): Title of the book/movie/show/etc.
- `comment` (String, optional): Short note or review.
