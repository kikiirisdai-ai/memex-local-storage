...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String activityStatsSummary(Object inputs, Object cards) {
    return 'この期間に $inputs 回記録し、$cards 枚のカードを生成しました。';
  }
  ...
  @override
  String get goalsPageTitle => 'マイゴール';

  @override
  String get goalsTabActive => '進行中';

  @override
  String get goalsTabCompleted => '完了';

  @override
  String get goalFormPageTitle => '新しい目標';

  @override
  String get goalFormTitleLabel => 'タイトル';

  @override
  String get goalFormTypeQuantitative => '数値目標';

  @override
  String get goalFormTypeBinary => '達成目標';

  @override
  String get goalFormTargetValueLabel => '目標値';

  @override
  String get goalFormUnitLabel => '単位(任意)';

  @override
  String get goalFormDeadlineLabel => '期限を選択';

  @override
  String get goalFormNoDeadline => '期限なし';

  @override
  String get goalFormTitleRequired => 'タイトルは必須です';

  @override
  String get goalFormTargetValueRequired => '有効な目標値を入力してください';

  @override
  String get goalMarkCompleted => '完了にする';

  @override
  String get goalReopen => '再開する';

  @override
  String get goalDeleteConfirmTitle => '目標を削除';

  @override
  String get mediaStatusWant => '見たい';

  @override
  String get mediaStatusDoing => '視聴中';

  @override
  String get mediaStatusDone => '視聴済み';

  @override
  String get mediaCommentHint => '短いレビューを書く(任意)';

  @override
  String get mediaStatusUnset => '未設定';

  @override
  String get mediaUnrated => '未評価';
  ...
  String get deleteAccountSafetySnapshotNote =>
      '削除前に安全スナップショットが作成されます。「バックアップと復元」から復元できます。';
  ...
  @override
  String get exportBackupNeverExported => 'まだ書き出していません ⚠️';
  ...
  @override
  String get exportReminderTitle => 'しばらくバックアップを書き出していません';

  @override
  String get exportReminderBody =>
      '「ファイル」に書き出せばアンインストールしても残ります・外部に書き出すことが本当の安全策です';

  @override
  String get exportReminderExportButton => '書き出す';

  @override
  String get exportReminderExporting => '書き出し中...';

  @override
  String get exportReminderSnoozeButton => '後で';

  @override
  String get iCloudDailyBackupTitle => 'iCloud 日次バックアップ';

  @override
  String get iCloudDailyBackupDesc =>
      'アプリを開くたびに、選択した iCloud フォルダへ自動的にバックアップし、最新の2件を保持します — アンインストールしても残ります。';

  @override
  String get iCloudPickFolder => 'iCloud フォルダを選択';

  @override
  String get iCloudChangeFolder => 'フォルダを変更';
  ...
  @override
  String get iCloudNeedsRepick => 'このフォルダにアクセスできません。iCloud フォルダを選び直してください';

  @override
  String get iCloudNotConfigured => 'まだフォルダが選択されていません。選択すると日次バックアップが始まります';

  @override
  String get iCloudRollingNote => '毎日上書きし、最新の2件を保持します';

  @override
  String get iCloudSynced => '同期済み';

  @override
  String get iCloudUploading => 'アップロード中…';

  @override
  String get iCloudNotUploaded => '未アップロード';

  @override
  String goalSuggestionIncrement(String title, String delta) {
    return '「$title」に$delta追加しますか？';
  }
  ...
  @override
  String get goalSuggestionConfirmed => '確認済み';
}
