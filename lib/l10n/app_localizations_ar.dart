...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String activityStatsSummary(Object inputs, Object cards) {
    return 'في هذه الفترة سجلت $inputs مرة، وأنشأت $cards بطاقة.';
  }
  ...
  @override
  String get goalsPageTitle => 'أهدافي';

  @override
  String get goalsTabActive => 'قيد التقدم';

  @override
  String get goalsTabCompleted => 'مكتملة';

  @override
  String get goalFormPageTitle => 'هدف جديد';

  @override
  String get goalFormTitleLabel => 'العنوان';

  @override
  String get goalFormTypeQuantitative => 'قابل للقياس';

  @override
  String get goalFormTypeBinary => 'نعم/لا';

  @override
  String get goalFormTargetValueLabel => 'القيمة المستهدفة';

  @override
  String get goalFormUnitLabel => 'الوحدة (اختياري)';

  @override
  String get goalFormDeadlineLabel => 'اختر الموعد النهائي';

  @override
  String get goalFormNoDeadline => 'بلا موعد نهائي';

  @override
  String get goalFormTitleRequired => 'العنوان مطلوب';

  @override
  String get goalFormTargetValueRequired => 'أدخل قيمة مستهدفة صالحة';
  ...
  @override
  String get mediaStatusWant => 'أريد المشاهدة';

  @override
  String get mediaStatusDoing => 'قيد التقدم';

  @override
  String get mediaStatusDone => 'انتهى';

  @override
  String get mediaCommentHint => 'أضف تعليقًا قصيرًا (اختياري)';

  @override
  String get mediaStatusUnset => 'لا توجد حالة';

  @override
  String get mediaUnrated => 'لم يتم التقييم بعد';
  ...
  String get deleteAccountSafetySnapshotNote =>
      'سيتم إنشاء لقطة أمان قبل الحذف — يمكنك استعادتها من النسخ الاحتياطي والاستعادة.';
  ...
  @override
  String get exportBackupNeverExported => 'لم يتم التصدير مطلقًا ⚠️';

  @override
  String exportBackupLastExported(String date) {
    return 'آخر تصدير: $date';
  }

  @override
  String get exportReminderTitle => 'لم تقم بنسخ احتياطي منذ فترة';

  @override
  String get exportReminderBody =>
      'التصدير إلى \"الملفات\" يبقى بعد إزالة التثبيت · التصدير خارجيًا هو ما يحميك فعليًا';

  @override
  String get exportReminderExportButton => 'تصدير';

  @override
  String get exportReminderExporting => 'جاري التصدير...';

  @override
  String get exportReminderSnoozeButton => 'لاحقًا';

  @override
  String get iCloudDailyBackupTitle => 'النسخ الاحتياطي اليومي لـ iCloud';

  @override
  String get iCloudDailyBackupDesc =>
      'ينسخ احتياطيًا تلقائيًا إلى مجلد iCloud الذي اخترته في كل مرة تفتح التطبيق، مع الاحتفاظ بآخر نسختين — يبقى بعد إزالة التثبيت.';

  @override
  String get iCloudPickFolder => 'اختر مجلد iCloud';

  @override
  String get iCloudChangeFolder => 'تغيير المجلد';

  @override
  String iCloudFolderLabel(Object name) {
    return 'النسخ الاحتياطي إلى: $name';
  }
  ...
  String get iCloudNeedsRepick =>
      'تعذّر الوصول إلى هذا المجلد — يرجى اختيار مجلد iCloud مرة أخرى';

  @override
  String get iCloudNotConfigured =>
      'لم يتم اختيار مجلد بعد — اختر واحدًا لبدء النسخ الاحتياطي اليومي';

  @override
  String get iCloudRollingNote => 'يُستبدل يوميًا، مع الاحتفاظ بآخر نسختين';

  @override
  String get iCloudSynced => 'تمت المزامنة';

  @override
  String get iCloudUploading => 'جارٍ الرفع…';

  @override
  String get iCloudNotUploaded => 'لم يتم الرفع';

  @override
  String goalSuggestionIncrement(String title, String delta) {
    return 'إضافة $delta إلى \"$title\"؟';
  }

  @override
  String goalSuggestionMarkComplete(String title) {
    return 'وضع علامة \"$title\" كمكتمل؟';
  }

  @override
  String get goalSuggestionConfirm => 'تأكيد';

  @override
  String get goalSuggestionConfirmed => 'مؤكَّد';
}
