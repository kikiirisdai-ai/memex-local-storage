...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String activityStatsSummary(Object inputs, Object cards) {
    return '이 기간 동안 $inputs번 기록했고, 카드 $cards장을 생성했습니다.';
  }
  ...
  @override
  String get goalsPageTitle => '내 목표';

  @override
  String get goalsTabActive => '진행 중';

  @override
  String get goalsTabCompleted => '완료';

  @override
  String get goalFormPageTitle => '새 목표';

  @override
  String get goalFormTitleLabel => '제목';

  @override
  String get goalFormTypeQuantitative => '수치형';

  @override
  String get goalFormTypeBinary => '완료형';

  @override
  String get goalFormTargetValueLabel => '목표값';

  @override
  String get goalFormUnitLabel => '단위(선택)';

  @override
  String get goalFormDeadlineLabel => '마감일 선택';

  @override
  String get goalFormNoDeadline => '마감일 없음';

  @override
  String get goalFormTitleRequired => '제목을 입력하세요';

  @override
  String get goalFormTargetValueRequired => '유효한 목표값을 입력하세요';

  @override
  String get goalMarkCompleted => '완료로 표시';

  @override
  String get goalReopen => '다시 열기';

  @override
  String get goalDeleteConfirmTitle => '목표 삭제';

  @override
  String get mediaStatusWant => '보고 싶음';

  @override
  String get mediaStatusDoing => '보는 중';

  @override
  String get mediaStatusDone => '완료';

  @override
  String get mediaCommentHint => '짧은 리뷰 작성(선택)';

  @override
  String get mediaStatusUnset => '상태 미설정';

  @override
  String get mediaUnrated => '평가 없음';
  ...
  String get deleteAccountSafetySnapshotNote =>
      '삭제 전에 안전 스냅샷이 생성됩니다. 백업 및 복원에서 복원할 수 있습니다.';
  ...
  @override
  String get exportBackupNeverExported => '아직 내보낸 적 없음 ⚠️';

  @override
  String exportBackupLastExported(String date) {
    return '마지막 내보내기: $date';
  }

  @override
  String get exportReminderTitle => '오랫동안 백업을 내보내지 않았어요';

  @override
  String get exportReminderBody =>
      '\"파일\"로 내보내면 삭제해도 남아있어요 · 외부로 내보내는 것이 진짜 안전한 방법이에요';

  @override
  String get exportReminderExportButton => '내보내기';

  @override
  String get exportReminderExporting => '내보내는 중...';

  @override
  String get exportReminderSnoozeButton => '나중에';

  @override
  String get iCloudDailyBackupTitle => 'iCloud 일일 백업';

  @override
  String get iCloudDailyBackupDesc =>
      '앱을 열 때마다 선택한 iCloud 폴더에 자동으로 백업하고 최근 2개를 보관합니다 — 삭제 후 재설치해도 유지됩니다.';

  @override
  String get iCloudPickFolder => 'iCloud 폴더 선택';

  @override
  String get iCloudChangeFolder => '폴더 변경';
  ...
  @override
  String get iCloudNeedsRepick => '이 폴더에 접근할 수 없습니다. iCloud 폴더를 다시 선택해 주세요';

  @override
  String get iCloudNotConfigured => '아직 폴더를 선택하지 않았습니다 — 선택하면 일일 백업이 시작됩니다';

  @override
  String get iCloudRollingNote => '매일 덮어쓰며 최근 2개를 보관합니다';

  @override
  String get iCloudSynced => '동기화됨';

  @override
  String get iCloudUploading => '업로드 중…';

  @override
  String get iCloudNotUploaded => '업로드되지 않음';

  @override
  String goalSuggestionIncrement(String title, String delta) {
    return '「$title」에 $delta 추가할까요?';
  }

  @override
  String goalSuggestionMarkComplete(String title) {
    return '「$title」완료로 표시할까요?';
  }

  @override
  String get goalSuggestionConfirm => '확인';

  @override
  String get goalSuggestionConfirmed => '확인됨';
}
