...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String activityStatsSummary(Object inputs, Object cards) {
    return 'За этот период вы сделали записей: $inputs, создали карточек: $cards.';
  }
  ...
  @override
  String get goalsPageTitle => 'Мои цели';

  @override
  String get goalsTabActive => 'В процессе';

  @override
  String get goalsTabCompleted => 'Завершено';

  @override
  String get goalFormPageTitle => 'Новая цель';

  @override
  String get goalFormTitleLabel => 'Название';

  @override
  String get goalFormTypeQuantitative => 'Измеримая';

  @override
  String get goalFormTypeBinary => 'Да/Нет';

  @override
  String get goalFormTargetValueLabel => 'Целевое значение';

  @override
  String get goalFormUnitLabel => 'Единица (необязательно)';

  @override
  String get goalFormDeadlineLabel => 'Выбрать срок';

  @override
  String get goalFormNoDeadline => 'Без срока';

  @override
  String get goalFormTitleRequired => 'Название обязательно';

  @override
  String get goalFormTargetValueRequired =>
      'Введите допустимое целевое значение';

  @override
  String get goalMarkCompleted => 'Отметить как выполненное';

  @override
  String get goalReopen => 'Возобновить';

  @override
  String get goalDeleteConfirmTitle => 'Удалить цель';

  @override
  String get mediaStatusWant => 'Хочу посмотреть';

  @override
  String get mediaStatusDoing => 'В процессе';

  @override
  String get mediaStatusDone => 'Завершено';

  @override
  String get mediaCommentHint => 'Добавьте короткий отзыв (необязательно)';

  @override
  String get mediaStatusUnset => 'Статус не задан';

  @override
  String get mediaUnrated => 'Пока без оценки';
  ...
  String get deleteAccountSafetySnapshotNote =>
      'Перед удалением будет создан снимок безопасности — вы можете восстановить его из раздела «Резервное копирование и восстановление».';
  ...
  @override
  String get exportBackupTitle => 'Экспорт резервной копии';

  @override
  String get exportBackupNeverExported => 'Ещё не экспортировалось ⚠️';
  ...
  String get exportReminderTitle =>
      'Вы давно не экспортировали резервную копию';

  @override
  String get exportReminderBody =>
      'Экспорт в «Файлы» сохраняется после удаления приложения · только внешний экспорт по-настоящему защищает данные';

  @override
  String get exportReminderExportButton => 'Экспорт';

  @override
  String get exportReminderExporting => 'Экспортируется...';

  @override
  String get exportReminderSnoozeButton => 'Позже';

  @override
  String get iCloudDailyBackupTitle =>
      'Ежедневное резервное копирование iCloud';

  @override
  String get iCloudDailyBackupDesc =>
      'Автоматически создаёт резервную копию в выбранной папке iCloud при каждом открытии приложения, сохраняя последние две копии — сохраняется после удаления приложения.';

  @override
  String get iCloudPickFolder => 'Выбрать папку iCloud';

  @override
  String get iCloudChangeFolder => 'Изменить папку';

  @override
  String iCloudFolderLabel(Object name) {
    return 'Резервное копирование в: $name';
  }

  @override
  String iCloudLastBackup(Object time) {
    return 'Последняя резервная копия: $time';
  }

  @override
  String get iCloudNeedsRepick =>
      'Не удаётся получить доступ к этой папке — пожалуйста, выберите папку iCloud снова';

  @override
  String get iCloudNotConfigured =>
      'Папка ещё не выбрана — выберите её, чтобы начать ежедневное резервное копирование';

  @override
  String get iCloudRollingNote =>
      'Перезаписывается ежедневно, сохраняются последние две копии';

  @override
  String get iCloudSynced => 'Синхронизировано';

  @override
  String get iCloudUploading => 'Загрузка…';

  @override
  String get iCloudNotUploaded => 'Не загружено';

  @override
  String goalSuggestionIncrement(String title, String delta) {
    return 'Добавить $delta к «$title»?';
  }
  ...
  @override
  String get goalSuggestionConfirm => 'Подтвердить';

  @override
  String get goalSuggestionConfirmed => 'Подтверждено';
}
