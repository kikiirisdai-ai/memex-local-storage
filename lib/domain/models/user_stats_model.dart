...
class UserStatsDailyPoint {
  ...
  /// Average effective mood (1-10) across cards on this day, computed
  /// deterministically without any LLM call. Null when no card that day
  /// carried a mood score — callers must render this as a gap, never 0.
