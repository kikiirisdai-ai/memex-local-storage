...
class StreamingTranscriber {
  ...
  Future<void> init() async {
    ...
    // Pre-warm the background transcription path with a tiny silent buffer.
    // The isolate takes seconds to cold-start; without this the first real
    // recording produces no live preview until it is already over.
    unawaited(
      WhisperService.instance
          .transcribeSamples(Float32List(1600))
