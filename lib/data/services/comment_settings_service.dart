...
/// - `enable_character_comment` (bool, default false): auto-generate character comments
...
class CommentSettings {
  ...
  // reversible: default is off to declutter AI character comments; flip
  // back to `true` (or toggle the setting in Settings > Comments) to
  // restore auto-generated character comments.
  const CommentSettings({
    this.showInsightText = true,
    this.enableCharacterComment = false,
  ...
  factory CommentSettings.fromYaml(Map yaml) {
    return CommentSettings(
      ...
      enableCharacterComment:
          yaml['enable_character_comment'] as bool? ?? false,
