...
class LlmImageCodec {
  ...
  /// 768px keeps local vision models (Ollama qwen3-vl etc.) responsive:
  /// a 2048px photo encodes to ~4k vision tokens and takes minutes to
  /// prefill on-device, while 768px is ~1/6 the tokens and still plenty
  /// for scene/object understanding. Stored originals are never touched.
